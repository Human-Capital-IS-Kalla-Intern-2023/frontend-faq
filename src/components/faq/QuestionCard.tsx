      ...
      <div className="w-full pl-6">
        <div className="relative bg-white shadow-lg">
          <div className="overflow-x-auto w-full">
            <div className="max-w-screen-xl items-start justify-start content-start mx-auto px-5 bg-white min-h-sceen">
              <div className="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8">
                <div className="py-5">
                  ...
                  >
                    ...
                    <button className="text-white bg-primary px-2  rounded mt-3">
                      Lihat Penuh
                    </button>
                  </details>
                </div>
